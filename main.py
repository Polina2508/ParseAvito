...
class Parser:   
    """Countind the number of pages"""
    
    @staticmethod
    async def main(url, params=None):

        async with aiohttp.ClientSession(headers={'Referer': URL }) as session:
        ...
        return loop.run_until_complete(await Parser.main(url, params=None))
